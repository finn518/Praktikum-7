...
class MainActivity : AppCompatActivity() {
   ...
   private  lateinit var zeus: ImageView
   private lateinit var sadCat: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        zeus = findViewById(R.id.zeus)
        sadCat = findViewById(R.id.sad)
        ...
        btnGet.setOnClickListener {
            if (!isPlay) {
                ...
                if (allSame) {
                    ...
                    tvHasil.text = "Anda menangg.............."
                } else {
                    tvHasil.visibility = View.VISIBLE
                    sadCat.visibility = View.VISIBLE
                    tvHasil.text = "Kasihan ya kalah :3"
                }
